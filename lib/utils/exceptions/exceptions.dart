...
class DefinedExceptions implements Exception {
  /// The associated error message.
  final String message;

  /// Default constructor with a generic error message.
  const DefinedExceptions([
    this.message = 'An unexpected error occurred. Please try again.',
  ]);

  /// Create an authentication exception from a Firebase authentication exception code.
  factory DefinedExceptions.fromCode(String code) {
    switch (code) {
      case 'email-already-in-use':
        return const DefinedExceptions(
      ...
      case 'invalid-password':
        return const DefinedExceptions('Incorrect password. Please try again.');
      case 'invalid-phone-number':
        return const DefinedExceptions('The provided phone number is invalid.');
      ...
      case 'sign_in_failed':
        return const DefinedExceptions('Sign-in failed. Please try again.');
